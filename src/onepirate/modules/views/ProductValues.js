        ...
        <Grid container spacing={5}>
          ...
          <Grid item xs={12} md={4}>
            <div className={classes.item}>
              ...
              <Typography variant="h5">
                {
                  "Once a source has been exposed as undeniably fake, measures will be taken to slow down or stop the source from providing further fake news to the public."
                }
              </Typography>
            </div>
          </Grid>
